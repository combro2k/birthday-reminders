...
use crate::auth::infrastructure::{api_token, password};
use crate::infrastructure::database::DatabasePool;
use crate::users::domain::repository::{NewUser, UpdateUser, UserRepository};
use crate::users::domain::user::{AuthMethod, Role, User, UserId};
...
impl UserCommandService {
    ...
    pub async fn update_theme(&self, user_id: &UserId, theme: &str) -> anyhow::Result<()> {
        let update = UpdateUser {
